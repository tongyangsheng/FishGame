...
class FishFiveViewController: UIViewController
{
    let maskView = UIView()
    ...
    let Bubble1 = BubbleView(frame: CGRect(x: 0.45*K_ScreenW, y: 0.1*K_ScreenH, width: 0.135*K_ScreenW, height: 0.72*0.135*K_ScreenW), idiom: "鹊巢鸠占")
    let Bubble2 = BubbleView(frame: CGRect(x: 0.1*K_ScreenW, y: 0.45*K_ScreenH, width: 0.135*K_ScreenW, height: 0.72*0.135*K_ScreenW), idiom: "相濡以沫")
...
extension FishFiveViewController
{
    private func setupUI()
    {
        ...
        fishView.frame = CGRect(x: 1.2*K_ScreenW, y: 100, width: 0.18*K_ScreenW, height: 0.695*0.108*K_ScreenW)
        ...
        fishBubble.loopMode = .loop
        //动画位置
        fishBubble.frame = CGRect(x: 0, y: -10, width: 0.092*K_ScreenW, height: 0.695*0.108*K_ScreenW)
        ...
        fishImage.image = UIImage(named: "鱼5")
        fishImage.frame = CGRect(x: 0.03*K_ScreenW, y: 0, width: 0.108*K_ScreenW, height: 0.695*0.108*K_ScreenW)
        ...
        barLeftFish.frame = CGRect(x: 0.04*K_ScreenW, y: 0.035*K_ScreenH, width: 0.06*K_ScreenW, height: 0.8*0.06*K_ScreenW)
        barLeftFish.image = UIImage(named: "小鱼4")
        self.view.addSubview(barLeftFish)
        
        barRightFish.frame = CGRect(x: 0.11*K_ScreenW + 0.29*K_ScreenW + 0.018*K_ScreenW, y: 0.02*K_ScreenH, width: 0.06*K_ScreenW, height: 0.06*K_ScreenW)
        barRightFish.image = UIImage(named: "小鱼6")
    ...
    @objc func setMask()
    {
        ...
        maskFish.image = UIImage(named: "鱼5")
...
extension FishFiveViewController
{
    ...
    {
        let NextVC = FishSixViewController()
    ...
    @objc func pressFeed(_ button: UIButton)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                self.view.makeToast(fishMessage, duration: 3.0, position: .bottom, title: "鱼儿：", image: UIImage(named: "鱼5"), style: ToastStyle(), completion: nil)
            }
        }
    }
    ...
    @objc func pressScreenshot(_ button: UIButton)
    {
        ...
        let WarningView = ScreenShotView(frame: UIScreen.main.bounds, fishTypeImageStr: "鱼5")
        WarningView.show()
    }
...
extension FishFiveViewController: CAAnimationDelegate
{
...
extension FishFiveViewController: UINavigationControllerDelegate
{
