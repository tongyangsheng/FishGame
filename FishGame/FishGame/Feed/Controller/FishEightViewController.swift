...
class FishEightViewController: UIViewController
{
    let maskView = UIView()
...
extension FishEightViewController
{
    ...
    @objc func setMask()
    {
        ...
        maskFish.image = UIImage(named: "鱼8")
...
extension FishEightViewController
{
    ...
    @objc func pressFeed(_ button: UIButton)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                self.view.makeToast(fishMessage, duration: 3.0, position: .bottom, title: "鱼儿：", image: UIImage(named: "鱼8"), style: ToastStyle(), completion: nil)
            }
        }
    }
    ...
    @objc func pressScreenshot(_ button: UIButton)
    {
        ...
        let WarningView = ScreenShotView(frame: UIScreen.main.bounds, fishTypeImageStr: "鱼8")
        WarningView.show()
    }
...
extension FishEightViewController: CAAnimationDelegate
{
...
extension FishEightViewController: UINavigationControllerDelegate
{
