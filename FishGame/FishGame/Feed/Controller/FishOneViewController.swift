    ...
    private func setupUI()
    {
        ...
        if UIDevice.current.userInterfaceIdiom == .pad
        {
            progressView.snp.makeConstraints { (maker) in
                ...
                maker.top.equalTo(0.049*K_ScreenH)
        ...
        barRightFish.frame = CGRect(x: 0.11*K_ScreenW + 0.29*K_ScreenW + 0.018*K_ScreenW, y: 0.03*K_ScreenH, width: 0.06*K_ScreenW, height: 0.775*0.06*K_ScreenW)
