...
class FishSevenViewController: UIViewController
{
    let maskView = UIView()
...
extension FishSevenViewController
{
    ...
    @objc func setMask()
    {
        ...
        maskFish.image = UIImage(named: "鱼7")
...
extension FishSevenViewController
{
    ...
    {
        let NextVC = FishEightViewController()
    ...
    @objc func pressFeed(_ button: UIButton)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                self.view.makeToast(fishMessage, duration: 3.0, position: .bottom, title: "鱼儿：", image: UIImage(named: "鱼7"), style: ToastStyle(), completion: nil)
            }
        }
    }
    ...
    @objc func pressScreenshot(_ button: UIButton)
    {
        ...
        let WarningView = ScreenShotView(frame: UIScreen.main.bounds, fishTypeImageStr: "鱼7")
        WarningView.show()
    }
...
extension FishSevenViewController: CAAnimationDelegate
{
...
extension FishSevenViewController: UINavigationControllerDelegate
{
