...
extension FishTwoViewController
{
    ...
    @objc func pressFeed(_ button: UIButton)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                self.view.makeToast(fishMessage, duration: 3.0, position: .bottom, title: "鱼儿：", image: UIImage(named: "鱼2"), style: ToastStyle(), completion: nil)
            }
        }
    }
    ...
    @objc func pressScreenshot(_ button: UIButton)
    {
        ...
        let WarningView = ScreenShotView(frame: UIScreen.main.bounds, fishTypeImageStr: "鱼2")
        WarningView.show()
    }
