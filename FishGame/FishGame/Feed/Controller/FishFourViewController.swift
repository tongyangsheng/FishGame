...
class FishFourViewController: UIViewController
{
    let maskView = UIView()
...
extension FishFourViewController
{
...
extension FishFourViewController
{
    ...
    {
        let NextVC = FishFiveViewController()
    ...
    @objc func pressFeed(_ button: UIButton)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                self.view.makeToast(fishMessage, duration: 3.0, position: .bottom, title: "鱼儿：", image: UIImage(named: "鱼4"), style: ToastStyle(), completion: nil)
            }
        }
    }
    ...
    @objc func pressScreenshot(_ button: UIButton)
    {
        ...
        let WarningView = ScreenShotView(frame: UIScreen.main.bounds, fishTypeImageStr: "鱼4")
        WarningView.show()
    }
...
extension FishFourViewController: CAAnimationDelegate
{
...
extension FishFourViewController: UINavigationControllerDelegate
{
